...
//   <IoIosEyeOff className="h-6 w-6 cursor-pointer" onClick={() => setShowConfirmPassword(!showConfirmPassword)} /> : <IoMdEye className="h-6 w-6 cursor-pointer" onClick={() => setShowConfirmPassword(!showConfirmPassword)} />}
